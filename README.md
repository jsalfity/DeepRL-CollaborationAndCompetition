...
Refer to the [Report](./Report.pdf) for a detailed explanation of the environment, software framework used, algorithm implemented, results and ideas for future work.

To train the agents yourself, please refer to [Tennis](./Tennis.ipynb) IPython notebook.
